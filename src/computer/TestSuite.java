...
public class TestSuite extends Utility {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder() {
        ...
        clikOnElement(By.linkText("Computers"));
        //Click on Desktop
        clikOnElement(By.linkText("Desktops"));
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        clikOnElement(By.xpath("//div[@class='product-item']/div[2]/div[3]/div[2]/button[1]"));
        ...
        clikOnElement(By.xpath("//input[@id='product_attribute_3_7']"));
        //Select OS radio "Vista Premium [+$60.00]"
        clikOnElement(By.xpath("//input[@id='product_attribute_4_9']"));
        // Check Two Check boxes "Microsoft Office [+$50.00]" and "Total Commander
        clikOnElement(By.xpath("//input[@id='product_attribute_5_12']"));
        Thread.sleep(2000);
        //Verify the price "$1,475.00"
        verifyText("$1,475.00", By.xpath("//span[@id='price-value-1']"), "$1,475.00");
        // Click on "ADD TO CARD" Button.
        clikOnElement(By.xpath("//button[@id='add-to-cart-button-1']"));
        ...
        clikOnElement(By.xpath("//body/div[@id='bar-notification']/div[1]/span[1]"));
        // Then MouseHover on "Shopping cart" and Click on "GO TO CART" button.
        mouseHoverAndClick(By.xpath("//li[@id='topcartlink']"));
        clikOnElement(By.xpath("//div[@class='buttons']/button"));
        ...
        clikOnElement(By.id("updatecart"));
        //verify the price
        ...
        clikOnElement(By.xpath("//button[contains(text(),'Checkout as Guest')]"));
        ...
        clikOnElement(By.xpath("//div[@id='billing-buttons-container']/button[4]"));
        Thread.sleep(8000);
        //Click on next day air($0.00)
        clikOnElement(By.xpath("//ul[@class='method-list']/li[2]/div[1]/input"));
        //click on continue button
        clikOnElement(By.xpath("//form[@id='co-shipping-method-form']/div[2]/button"));
        //click on credit card radio button
        clikOnElement(By.xpath("//ul[@class='method-list']/li[2]/div/div[2]/input"));
        //Click on continue button
        clikOnElement(By.xpath("//div[@id='checkout-step-payment-method']/div/button"));
        Thread.sleep(5000);
